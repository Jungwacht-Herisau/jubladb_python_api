...
class Group(jubladb_api.core.base_entity.BaseEntity):
    def __init__(
        ...
        creator: jubladb_api.generated.entities.keys.PersonKey,
        updater: jubladb_api.generated.entities.keys.PersonKey,
        deleter: jubladb_api.generated.entities.keys.PersonKey,
        parent: jubladb_api.generated.entities.keys.GroupKey,
        layer_group: jubladb_api.generated.entities.keys.GroupKey,
        phone_numbers: list[jubladb_api.generated.entities.keys.PhoneNumberKey],
        social_accounts: list[jubladb_api.generated.entities.keys.SocialAccountKey],
        additional_emails: list[jubladb_api.generated.entities.keys.AdditionalEmailKey],
    ):
        super().__init__(id_)
