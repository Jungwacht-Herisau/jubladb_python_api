...
class Course(jubladb_api.core.base_entity.BaseEntity):
    ...
    def from_json(cls, json_data: dict):
        ...
        return cls(
            ...
            training_days=float(json_data["attributes"]["training_days"]),
            applicant_count=int(json_data["attributes"]["applicant_count"]),
            participant_count=int(json_data["attributes"]["participant_count"]),
            minimum_participants=int(json_data["attributes"]["minimum_participants"]),
            number=str(json_data["attributes"]["number"]),
            teamer_count=int(json_data["attributes"]["teamer_count"]),
