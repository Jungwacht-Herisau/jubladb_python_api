...
ROLE_FEDERALBOARD_MEMBER = RoleType("Group::FederalBoard::Member", "Mitglied", [":admin", ":layer_and_below_full", ":contact_data"], True, GROUP_FEDERALBOARD)
ROLE_FEDERALBOARD_PRESIDENT = RoleType("Group::FederalBoard::President", "Präses", [":admin", ":layer_and_below_full", ":contact_data"], True, GROUP_FEDERALBOARD)
...
ROLE_FLOCK_LEADER = RoleType("Group::Flock::Leader", "Scharleitung", [":layer_and_below_full", ":contact_data", ":approve_applications", ":manual_deletion"], False, GROUP_FLOCK)
...
ROLE_FLOCK_TREASURER = RoleType("Group::Flock::Treasurer", "Kassier*in", [":layer_and_below_read", ":contact_data", ":finance"], True, GROUP_FLOCK)
...
ROLE_NEJB_ITSUPPORT = RoleType("Group::Nejb::ITSupport", "IT Support", [":admin", ":impersonation"], True, GROUP_NEJB)
ROLE_NEJBBUNDESLEITUNG_GROUPADMIN = RoleType("Group::NejbBundesleitung::GroupAdmin", "Adressverwaltung", [":admin", ":layer_and_below_full", ":contact_data"], True, GROUP_NEJBBUNDESLEITUNG)
