...
class PhoneNumbersResource(BaseModel):
    """
    PhoneNumbersResource
    """ # noqa: E501
    id: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    attributes: Optional[PhoneNumbers] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['phone_numbers']):
            raise ValueError("must be one of enum values ('phone_numbers')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": PhoneNumbers.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
