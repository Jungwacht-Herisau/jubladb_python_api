...
class PhoneNumbersSingle(BaseModel):
    """
    PhoneNumbersSingle
    """ # noqa: E501
    data: Optional[PhoneNumbersResource] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": PhoneNumbersResource.from_dict(obj["data"]) if obj.get("data") is not None else None,
