...
class InvoiceItemsSingle(BaseModel):
    """
    InvoiceItemsSingle
    """ # noqa: E501
    data: Optional[InvoiceItemsResource] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": InvoiceItemsResource.from_dict(obj["data"]) if obj.get("data") is not None else None,
