...
class SocialAccountsSingle(BaseModel):
    """
    SocialAccountsSingle
    """ # noqa: E501
    data: Optional[SocialAccountsResource] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": SocialAccountsResource.from_dict(obj["data"]) if obj.get("data") is not None else None,
