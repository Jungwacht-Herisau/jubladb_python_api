...
class EventKindsCollection(BaseModel):
    """
    EventKindsCollection
    """ # noqa: E501
    data: Optional[List[EventKindsResource]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [EventKindsResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
