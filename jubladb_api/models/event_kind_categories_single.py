...
class EventKindCategoriesSingle(BaseModel):
    """
    EventKindCategoriesSingle
    """ # noqa: E501
    data: Optional[EventKindCategoriesResource] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": EventKindCategoriesResource.from_dict(obj["data"]) if obj.get("data") is not None else None,
