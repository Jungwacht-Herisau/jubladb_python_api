...
class PeopleResource(BaseModel):
    """
    PeopleResource
    """ # noqa: E501
    id: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    attributes: Optional[People] = None
    relationships: Optional[PeopleRelationships] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['people']):
            raise ValueError("must be one of enum values ('people')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": People.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": PeopleRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "links": dict(
