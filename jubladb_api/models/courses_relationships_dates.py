...
class CoursesRelationshipsDates(BaseModel):
    """
    CoursesRelationshipsDates
    """ # noqa: E501
    links: Optional[JsonapiRelationshipLinks] = None
    data: Optional[List[JsonapiLinkage]] = Field(default=None, description="An array of objects each containing \"type\" and \"id\" members for to-many relationships.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [JsonapiLinkage.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "meta": obj.get("meta")
        })
        return _obj
