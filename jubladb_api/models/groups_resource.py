...
class GroupsResource(BaseModel):
    """
    GroupsResource
    """ # noqa: E501
    id: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    attributes: Optional[Groups] = None
    relationships: Optional[GroupsRelationships] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['groups']):
            raise ValueError("must be one of enum values ('groups')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": Groups.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": GroupsRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "links": dict(
