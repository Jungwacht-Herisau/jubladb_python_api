...
class AdditionalEmailsSingle(BaseModel):
    """
    AdditionalEmailsSingle
    """ # noqa: E501
    data: Optional[AdditionalEmailsResource] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AdditionalEmailsResource.from_dict(obj["data"]) if obj.get("data") is not None else None,
