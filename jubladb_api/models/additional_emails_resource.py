...
class AdditionalEmailsResource(BaseModel):
    """
    AdditionalEmailsResource
    """ # noqa: E501
    id: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    attributes: Optional[AdditionalEmails] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['additional_emails']):
            raise ValueError("must be one of enum values ('additional_emails')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": AdditionalEmails.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
