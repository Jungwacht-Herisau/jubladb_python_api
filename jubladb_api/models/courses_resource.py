...
class CoursesResource(BaseModel):
    """
    CoursesResource
    """ # noqa: E501
    id: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    attributes: Optional[Courses] = None
    relationships: Optional[CoursesRelationships] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['courses']):
            raise ValueError("must be one of enum values ('courses')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": Courses.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": CoursesRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "links": dict(
